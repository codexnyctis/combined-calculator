<template>
  <div class="sectionContainer" :class="{ 'neonBorder': showNeonBorder }">
    ...
    <div class="costDisplay" v-if="showCostDisplay">
      <div class="costShell">
        ...
        <div class="slider-container">
          <span class="percentage">{{ superchargerPercentage }}%</span>
...
// Computed property to control the visibility of Cost Display
const showCostDisplay = computed(() => {
  // Burada, tüm seçimler yapıldıktan sonra Cost Display'in görünürlüğünü kontrol edebilirsiniz.
  return selectedMake.value && selectedModel.value && selectedVariant.value && selectedState.value && chargingMethod.value;
});
...
// Computed property to control the visibility of neon border
const showNeonBorder = computed(() => {
  return selectedMake.value && selectedModel.value && selectedVariant.value && selectedState.value && chargingMethod.value;
});
...
.sectionContainer.neonBorder {
  border: 2px solid #8a2be2;
  box-shadow: 0 0 10px #8a2be2;
  background-color: #1f0b36;
}

.sectionContainer.neonBorder .selections {
  border: none;
  box-shadow: none
}
